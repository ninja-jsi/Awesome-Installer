...
echo -e "\e[34mBold[+] Updating system...\e[0m"
sudo apt update && sudo apt upgrade -y

echo -e "\e[34mBold[+] Installing Golang...\e[0m"
wget https://go.dev/dl/go1.23.6.linux-amd64.tar.gz
sudo tar -xzf go1.23.6.linux-amd64.tar.gz
rm go1.23.6.linux-amd64.tar.gz
mv go /usr/local

echo -e "\e[34mBold[+] Setting up Go PATH...\e[0m"
...
echo -e "\e[34mBold[+] Installing basic dependencies...\e[0m"
...
echo -e "\e[34mBold[+] Installing ProjectDiscovery tools...\e[0m"
go install github.com/projectdiscovery/subfinder/v2/cmd/subfinder@latest
go install github.com/projectdiscovery/httpx/cmd/httpx@latest
go install github.com/projectdiscovery/naabu/v2/cmd/naabu@latest
go install github.com/projectdiscovery/nuclei/v3/cmd/nuclei@latest

echo -e "\e[34mBold[+] Installing Assetfinder, Amass, Gau, Dalfox, Gf...\e[0m"
...
echo -e "\e[34mBold[+] Installing Feroxbuster...\e[0m"
echo -e "\e[34mBold[+] Installing latest Feroxbuster...\e[0m"
...
echo -e "\e[34mBold[+] Feroxbuster installed!\e[0m"

echo -e "\e[34mBold[+] Setting up GF patterns...\e[0m"
if [ ! -d ~/.gf ]; then
    mkdir -p ~/.gf
...
echo -e "\e[34mBold[+] Installation complete!\e[0m"
echo -e "\e[34mBoldEnsure Go binaries are in PATH: $(go env GOPATH)/bin\e[0m"
echo -e "\e[34mBoldYou may need to restart terminal or run: source ~/.bashrc\e[0m"
